  ...
  return (
    <section id="hero" className=" w-full h-screen relative cursor-grab">
      <div className={`absolute inset-0 top-[120px]  max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={"font-black text-white lg:text-[80px]  text-[50px] lg:leading-[98px] mt-2 "}>
            Hi, I'm <span className="text-[#915EFF]">Ewan</span>
          </h1>
          <p className={"text-[#dfd9ff] font-medium lg:text-[30px]  text-[26px] lg:leading-[40px] mt-2 text-white-100"}>
      ...
      <div className="absolute bottom-4 lg:bottom-0 w-full h-80 lg:h-40 flex justify-center items-center">
        <a href="#about">
